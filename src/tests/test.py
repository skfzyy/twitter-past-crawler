...
#             twitterpastcrawler.parse_html(twitterpastcrawler.html_to_tweet_object, data["items_html"]))
...
if __name__ == '__main__':
    # unittest.main()
    import twitterpastcrawler_t as crawler

    reptile = crawler.TwitterCrawler(query="Portuguese Empire", lang="en", max_depth=2,
                                     output_file="/Users/moonknight/project/python/dataset/temp/init_data.json")
    reptile.crawl()
